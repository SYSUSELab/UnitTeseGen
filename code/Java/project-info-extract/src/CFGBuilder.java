...
public class CFGBuilder {
    void buildCFG() {
        ...
        CtMethod<?> method = ctClass.getMethodsByName("extractMethodInfo").get(0); // Changed to getMethodsByName
        // CtMethod<?> method2 = ctClass.getMethodsByName("extractClassInfo").get(0); // Changed to getMethodsByName
        ControlFlowBuilder builder = new ControlFlowBuilder();  
        ControlFlowGraph cfg = builder.build(method);
        // ControlFlowGraph cfg2 = builder.build(method2);
        // ControlFlowGraph cfg = builder.build(ctClass);
